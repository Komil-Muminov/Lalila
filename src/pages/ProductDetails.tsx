...
export const ProductDetails: React.FC = () => {
  ...
  // Effect to set default size once product is loaded
  useEffect(() => {
  ...
  if (isError || !product) return <div className="h-screen flex items-center justify-center">Product not found</div>;
    ...
    <div className="min-h-screen pt-20 flex flex-col lg:flex-row overflow-hidden">
      ...
      >
        ...
        <div className="flex gap-4 mt-auto pt-8 border-t border-current border-opacity-10">
          ...
          >
            {product.inStock ? (<><ShoppingBag size={20} /> Add to Bag</>) : 'Out of Stock'}
          </button>
        </div>
